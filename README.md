...
1. Add example GitHub repo https://github.com/coreydinkens/tmc-flux-poc
2. Add pre-reqs folder Flux kustomization
3. Add flux-config folder Flux kustomization
